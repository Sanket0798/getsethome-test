...
const About = () => {
  return (
    <div className="w-auto md:w-[768px] lg:w-full h-[810px] md:h-auto lg:h-[744px] bg-[#EDDBDB] py-[20px] md:py-[30px] lg:py-[60px] px-[20px] md:px-[20px] lg:px-0">
      <section className="w-auto lg:w-1200 mx-auto flex flex-col lg:flex-row items-start justify-between md:items-center md:justify-center lg:items-start lg:justify-between h-[1150px] lg:h-[624px]">
        <div className="flex flex-col items-start">
          <p className="text-black font-extrabold md:text-[42px] w-[340px] md:w-full lg:w-[575px] md:leading-[50px] text-[35px] leading-[40px]">
            Reduce your rental expense with{" "}
            <span className="text-[#6B31E7]">GetSetHome</span>
          </p>
          {aboutContent.map(({ title, desc }, index) => (
            <div key={index} className="w-[370px] md:w-full lg:w-[575px]">
