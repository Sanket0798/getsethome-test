...
const About = () => {
  return (
    <div className="w-auto md:w-[768px] lg:w-full h-[810px] md:h-[744px] bg-[#EDDBDB] py-[20px] md:py-[60px] px-[20px] md:px-[20px] lg:px-0">
      <section className="w-auto md:w-1200 mx-auto flex flex-col md:flex-row items-start justify-between h-full">
        <div className="flex flex-col items-start">
          ...
          {aboutContent.map(({ title, desc }, index) => (
            <div key={index} className="w-[370px] md:w-[575px]">
