  ...
  return (
    <section className="w-auto md:w-[768px] lg:w-1200 mx-auto h-auto md:h-[945px] py-[20px] md:py-[60px] px-[10px] md:px-0">
      <div className="w-full h-full flex flex-col justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] justify-between mt-[20px] md:mt-0">
          {servicesContent.map((value, index) => (
            <div
              key={index}
              className="w-auto md:w-[380px] h-[370px] bg-[#F9F9F9] rounded-[20px] p-[40px] flex flex-col items-start"
            >
